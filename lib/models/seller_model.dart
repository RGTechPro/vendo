...
class SellerUniversal{
 ...
 factory SellerUniversal.fromMap(Map<String,dynamic> parsedJson){
  return SellerUniversal(
   ...
   isSpeciallyAbled : parsedJson['isSpeciallyAbled'] == null ? false : parsedJson['isSpeciallyAbled'],
   aadharNumber : parsedJson['aadharNumber'],
   localName : parsedJson['localName'],
   address : parsedJson['address'],
   timing : parsedJson['timing'],
   farmerType : parsedJson['farmerType'] == null ? null : farmer_type.values.elementAt(parsedJson['farmerType']),
   servicesProvided : parsedJson['servicesProvided'],
   charges : parsedJson['charges'],
   description : parsedJson['description'],
   shopName : parsedJson['shopName'],
   shopPhotos : parsedJson['shopPhotos'] == null ? [] : parsedJson['shopPhotos'],
   productListPhotos : parsedJson['productListPhotos'] == null ? [] : parsedJson['productListPhotos'],
   productPhotos : parsedJson['productPhotos'] == null ? [] : parsedJson['productPhotos'],
   packagingInfo : parsedJson['packagingInfo'],
   isHomeDeliveryAvaliable : parsedJson['isHomeDeliveryAvaliable'] == null ? false : parsedJson['isHomeDeliveryAvaliable'],
   enableLiveLocation : parsedJson['enableLiveLocation'] == null ? false : parsedJson['enableLiveLocation'],
  );
 }
